...
class NormalSitupsSlidePageFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val root = inflater.inflate(R.layout.situps_slide_fragment_normal, container, false)
